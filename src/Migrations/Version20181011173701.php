 ...
 */
final class Version20181011173701 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE questions (id INT AUTO_INCREMENT NOT NULL, qcategory SMALLINT NOT NULL, qdifficultylevel SMALLINT NOT NULL, userid INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
